...
export const homepageText = `
  ...
  <h5>The Big Bowl History 🏆:</h5>
  <h4>The Big Bowl I (2023)</h4>
  Champion: Los Azules (Bolo) - After finishing the regular season at 6–8, Los Azules caught fire at the perfect time. Powered by a legendary wide receiver trio of CeeDee Lamb, Justin Jefferson, and Davante Adams, they completed one of the most improbable playoff runs in TBD history.</p>
  <p>The Big Bowl II (2024) - Champion: Norcal Seleção (Gavin) - Norcal Seleção asserted dominance throughout the season, capturing the championship behind a stacked roster led by Trey McBride, Ja’Marr Chase, and rookie standout Malik Nabers. Their title run marked the rise of one of TBD’s earliest powerhouses.</p>
  <p>The Big Bowl III (2025) - Champion: Avós All-Stars (Daniel) - Entering the playoffs as the 4 seed with an 8–6 regular-season record, Daniel and the Avós All-Stars navigated a competitive field and claimed the third Big Bowl title, adding another chapter to TBD’s growing legacy.</p>
