...
export const leagueName = "TBD"; // your league name
...
export const homepageText = `
  ...
  <p>In its inaugural season, and led by an unimaginable wide receiver room of CeeDee Lamb, Justin Jefferson, and Davante Adams, Los Azules (formerly My Diggs Small) stunned the league by storming from a 6-8 regular season finish to win it all in the playoffs. The following year, Norcal Seleçáo rose to power, claiming the 2024 championship behind a loaded roster headlined by Trey McBride, Ja'Marr Chase, and rookie Malik Nabers.</p>
