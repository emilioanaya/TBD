...
export const homepageText = `
  ...
  <p>The Big Bowl I (2023) - Champion: Los Azules (formerly My Diggs Small) - After finishing the regular season at 6–8, Los Azules caught fire at the perfect time. Powered by a legendary wide receiver trio of CeeDee Lamb, Justin Jefferson, and Davante Adams, they completed one of the most improbable playoff runs in TBD history.</p>
  <p>The Big Bowl II (2024) - Champion: Norcal Seleção - Norcal Seleção asserted dominance throughout the season, capturing the championship behind a stacked roster led by Trey McBride, Ja’Marr Chase, and rookie standout Malik Nabers. Their title run marked the rise of one of TBD’s earliest powerhouses.</p>
