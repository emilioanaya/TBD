 ...
 * @param {Object} regularSeasonInfo.leagueData the basic info about the league that season
...
/**
 * Processes the matchups for a given week of a season. Calculates weekly points, differentials, and adds the points to the season-long points
